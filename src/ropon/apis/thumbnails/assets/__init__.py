...
class RenderAsset:
    ...
    @with_auth_token
    def render_assets(self, item_id: int | None, thumbnail_size: Literal["48x48", "50x50", "60x60", "75x75", "100x100", "150x150", "180x180", "352x352", "420x420", "720x720"], formanttype: Literal["Png", "Jpeg", "Webp"],**kwargs):
        try:
            ...
            req = requests.get(
                f"https://thumbnails.roblox.com/v1/assets?assetIds={item_id}&returnPolicy=PlaceHolder&size={thumbnail_size}&format=Png&isCircular=false",
                headers=headers
            )
